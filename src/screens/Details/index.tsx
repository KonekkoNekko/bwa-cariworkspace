    ...
    return (
      <View style={styles.descriptionContainer}>
        ...
        <Text style={Gs.textGrey}>
          ...
          ipsum, corporis vero aspernatur corrupti ut commodi molestias!
          Quisquam omnis debitis sit blanditiis deleniti. Sit amet obcaecati
          deleniti ea nemo minus.
        </Text>
      </View>
    );
  };
  ...
  const renderBookingButton = () => {
    return (
      <View style={styles.bookingButtonContainer}>
        <View>
          <Text style={[Gs.textPrimary, Gs.h1]}>$5,499</Text>
